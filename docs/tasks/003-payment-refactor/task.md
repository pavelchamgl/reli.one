...
- `payment/views.py` — 2198 строк, весь критический путь в одном файле (BE-2)
...
### Цель
Декомпозировать `payment/views.py` (2198 строк) в сервисный слой.
...
- BE-2: `payment/views.py` 2198 строк P1
