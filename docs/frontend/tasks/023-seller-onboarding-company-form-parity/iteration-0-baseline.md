...
| ID | Area | Iteration | Type |
|----|------|-----------|------|
| F1 | `wCountry`, `rCountry` не в Yup | 1+2 | Validation bug |
| F2 | `tin` условный | 1+2 | Validation bug |
| F3 | `bank_code` visibility logic | 2 | Functional bug |
| F4 | Документы не валидируются | 2 | Validation gap |
| F5 | PUT errors нет на полях | 2 | UX |
| F6 | `certificate_issue_date` как upload proxy | 2 | Functional |
| F7 | `account_holder` empty блокирует | 2 | UX |
| V1 | Upload dropzone style | 3 | Visual |
| V2 | Card/header/step styling | 3 | Visual |
