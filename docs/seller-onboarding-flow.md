...
| Views | `backend/sellers/views_onboarding.py`; state/review/submit: `backend/sellers/onboarding/steps/state.py`, `backend/sellers/onboarding/review/review.py`, `backend/sellers/onboarding/review/submit.py` |
