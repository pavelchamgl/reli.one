...
| Views | `backend/sellers/views_onboarding.py`; вынесено: `onboarding/steps/state.py`, `seller_type.py`, `self_employed.py`, **`company.py`**, `onboarding/review/review.py`, `onboarding/review/submit.py` |
