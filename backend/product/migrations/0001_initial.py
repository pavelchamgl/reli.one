    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.DecimalField(blank=True, decimal_places=1, default=Decimal('1.0'), max_digits=2, null=True, validators=[django.core.validators.MinValueValidator(Decimal('1.0')), django.core.validators.MaxValueValidator(Decimal('5.0'))])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='license_file', to='product.baseproduct')),
            ],
        ),
        migrations.CreateModel(
