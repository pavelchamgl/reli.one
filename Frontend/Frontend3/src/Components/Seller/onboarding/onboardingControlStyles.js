...
/**
 * Select trigger styling — explicit solid border with !important because legacy
 * global `button { border: none; }` (App.css) overrides Tailwind border utilities.
 */
export const onboardingSelectTriggerClassName = `${onboardingControlClassName} !border !border-solid !border-[#D1D5DB] bg-background shadow-sm`;
