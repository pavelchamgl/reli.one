    ...
    return (
        <section className={styles.main}>
            ...
            <ul className={styles.infoList}>
                <li>
                    <p>{t('onboard.reg.first_name')}</p>
                    <span>{firstName || "—"}</span>
                </li>
                <li>
                    <p>{t('onboard.reg.last_name')}</p>
                    <span>{lastName || "—"}</span>
                </li>
                <li>
                ...
                <li>
                    <p>{t('onboard.seller_info.nationality')}</p>
                    <span>{nationality?.text || data?.nationality || "—"}</span>
                </li>
                {!isCompany && (
                    <>
                        <li>
            ...
            {
                !isCompany && storeData?.front && storeData?.back &&
                <div>
