  ...
  return (
    <SellerOnboardingLayout>
      <ApplicationSubmittedView
        ...
        description={t('onboard.status.submitted_desc')}
        statusLabel={t('onboard.status.application_status_label')}
        pendingStatusLabel={t('onboard.status.pending_status')}
        pendingTime={t('onboard.status.pending_time')}
        notification={t('onboard.status.notification')}
        nextTitle={t('onboard.status.next_title')}
        nextSteps={[
          t('onboard.status.next_step_1'),
          t('onboard.status.next_step_2'),
          t('onboard.status.next_step_3'),
        ]}
        returnHomeLabel={t('onboard.common.return_to_homepage')}
        returnHomeHref="https://info.reli.one/"
        needHelpLabel={t('onboard.common.need_help')}
        contactSupportLabel={t('onboard.common.contact_support')}
        contactSupportHref="https://info.reli.one/#contact"
